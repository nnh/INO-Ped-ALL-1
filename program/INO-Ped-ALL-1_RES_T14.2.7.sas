...
*
* Program name      : INO-Ped-ALL-1_STAT_T14.2.7.sas
*
* Author            : MATSUO YAMAMOTO
*
* Date created      : 20210127
*
* Purpose           : Create T14.2.7
*
* Revision History  : 
*
...
ods graphics on / height = 10cm width = 15cm imagename = 'T14_2_7'
...
data _null_;
  file sys;
  put '[select("r6c2")]';
  put "[insert.picture(""&output.\KM\T14_2_7.png"")]";
run ;
