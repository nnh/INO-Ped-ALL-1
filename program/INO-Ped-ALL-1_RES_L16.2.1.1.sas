...
*
* Program name      : INO-Ped-ALL-1_STAT_L16.2.1.1.sas
*
* Author            : MATSUO YAMAMOTO
*
* Date created      : 20210114
*
* Purpose           : Create L16.2.1.1
*
* Revision History  : 
*
...
data  wk00;
  set  libraw.adds;
  if  PARAMCD="WITHDRAW" /*and AVALC^="COMPLETED"*/;
  DOSLV=1;
run ;
...
%mend;
%xlsout01(&file.,r&strow.c2:r%eval(&prerow.+&obs.)c10,wk00,SUBJID DOSLV SITENM SEX AGE ASTDT ASTDY AVALC);
