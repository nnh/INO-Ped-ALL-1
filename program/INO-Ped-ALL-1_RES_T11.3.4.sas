...
*
* Program name      : INO-Ped-ALL-1_STAT_T11.3.4.sas
*
* Author            : MATSUO YAMAMOTO
*
* Date created      : 20210127
*
* Purpose           : Create T11.3.4
*
* Revision History  : 
*
...
data  adpr1;
  set  adpr;
  if  PRCAT="COMBINATION THERAPY";
  proc sort nodupkey; by USUBJID PRTRT; 
run ;

proc freq data=adpr1 noprint;
  tables PRTRT/out=out1 outcum;
run;
...
%mend;
%xlsout01(&file.,r&strow.c2:r%eval(&prerow.+&obs.)c4,wk00,OUT0 OUT1 OUT2);
