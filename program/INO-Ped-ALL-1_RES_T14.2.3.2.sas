...
*
* Program name      : INO-Ped-ALL-1_STAT_T14.2.3.2.sas
*
* Author            : MATSUO YAMAMOTO
*
* Date created      : 20210127
*
* Purpose           : Create T14.2.3.2
*
* Revision History  : 
*
...
proc sort data=base; by AVISITN; run ;
...
%mend;
%xlsout01(&file.,r8c4:r11c6,wk00,OUT1-OUT3);
