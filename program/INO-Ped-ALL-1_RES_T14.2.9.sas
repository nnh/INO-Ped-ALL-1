...
*
* Program name      : INO-Ped-ALL-1_STAT_T14.2.9.sas
*
* Author            : MATSUO YAMAMOTO
*
* Date created      : 20210127
*
* Purpose           : Create T14.2.9
*
* Revision History  : 
*
...
%macro bin(val,outf);
  ...
  *---------- 後でweight考慮するために集計;
  proc freq data = base  noprint;
      tables &val. / out = base_freq ;
  run;

  *---------- dummy data;
  data dum;
      length  &val. $200.;
      &val. = "N"; COUNT = 0; output;
      &val. = "Y"; COUNT = 0; output;
  run;
