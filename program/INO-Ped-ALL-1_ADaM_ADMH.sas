...
*
* Program name      : INO-Ped-ALL-1_ADaM_ADMH.sas
*
...
data  wk11;
  ...
  keep 
    ...
    MHENTPT
  ;
  set  mh(rename=(MHSEQ=_MHSEQ));
  if MHCAT="GENERAL";
  MHSEQ=input(_MHSEQ,best32.);
run ;
...
proc sql ;
   ...
   select
    ...
    MHTERM  LENGTH=200    LABEL="Reported Name of Drug, Med, or Therapy",
    MHDECOD  LENGTH=200    LABEL="Standardized Medication Name",
    MHCAT  LENGTH=200    LABEL="Category for Medication",
    MHENRTPT  LENGTH=200    LABEL="End Relative to Reference Time Point",
    MHENTPT  LENGTH=200    LABEL="End Reference Time Point"
   from wk00;
quit ;
