...
*
* Program name      : INO-Ped-ALL-1_STAT_T14.2.2.1.sas
*
* Author            : MATSUO YAMAMOTO
*
* Date created      : 20210127
*
* Purpose           : Create T14.2.2.1
*
* Revision History  : 
*
...
proc transpose   data=wk01   out=wk00 ;
      var  out1  ;
      by   no ;
run;
...
%mend;
%xlsout01(&file.,r7c3:r7c10,wk00,COL1-COL8);
