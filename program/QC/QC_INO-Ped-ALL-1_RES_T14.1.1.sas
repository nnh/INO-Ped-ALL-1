...
%macro EDIT_MEANS_T14_1_1_PBLST(input_ds, output_ds, target_var, class_f=., class_var='');
...
data adsl;
    length output_PBLSGR1 $200.;
    set libinput.adsl;
    where &target_flg.='Y';
    output_PBLST=PBLST*0.01*WBC;
    if output_PBLST=0 then do;
      output_PBLSGR1="0";
      output_PBLSGR1N=1;
    end; 
    else if 0<output_PBLST and output_PBLST<=1000 then do;
      output_PBLSGR1=">0- 1,000";
      output_PBLSGR1N=2;
    end;
    else if 1000<output_PBLST and output_PBLST<=5000 then do;
      output_PBLSGR1=">1,000- 5,000";
      output_PBLSGR1N=3;
    end;
    else if 5000<output_PBLST and output_PBLST<=10000 then do;
      output_PBLSGR1=">5,000- 10,000";
      output_PBLSGR1N=4;
    end;
    else if 10000<output_PBLST then do;
      output_PBLSGR1=">10,000";
      output_PBLSGR1N=5;
    end;
    else do;
      output_PBLSGR1="";
...
%let seq=%eval(&seq.+1);
%EDIT_MEANS_T14_1_1_PBLST(adsl, output_&seq., output_PBLST);
%let seq=%eval(&seq.+1);
%EDIT_N_PER_2(adsl, output_&seq., output_PBLSGR1, %str('0Åb>0- 1,000Åb>1,000- 5,000Åb>5,000- 10,000Åb>10,000'), 'Åb', 0);
%let seq=%eval(&seq.+1);
