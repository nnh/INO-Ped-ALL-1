**************************************************************************
Program Name : QC_INO-Ped-ALL-1_RES_T14.3.12.sas
...
proc sql noprint;
    ...
    from libinput.adae
    where (&target_flg.='Y') and (AESER='Y')
