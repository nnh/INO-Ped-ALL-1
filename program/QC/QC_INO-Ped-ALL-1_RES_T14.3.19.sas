**************************************************************************
Program Name : QC_INO-Ped-ALL-1_RES_T14.3.19.sas
...
proc sql noprint;
    ...
    from libinput.adae
    where (&target_flg.='Y') and (AESER='Y') and (AEACN='DRUG REDUCED') and (AEREL='RELATED')
