...
*
* Program name      : INO-Ped-ALL-1_STAT_Table8.sas
*
* Author            : MATSUO YAMAMOTO
*
* Date created      : 20210114
*
* Purpose           : Create Table8
*
* Revision History  : 
*
...
data  wk01;
  set  libraw.adcm;
  DOSLV=1;
  if CMCAT ^in("PRE-TRANSPLANT TREATMENT DRUG","GVHD PREVENTION DRUG");
run ;

proc sort data=wk01 nodupkey dupout=aaa; by USUBJID CMCAT ASTDT AENDT CMTRT CMDECOD; run ;
...
%mend;
%xlsout01(&file.,r&strow.c2:r%eval(&prerow.+&obs.)c12,wk00,DOSLV SUBJID CMCAT CMTRT CMDECOD CMDOSE CMDOSU CMDOSFRQ CMROUTE ASTDT AENDT);
