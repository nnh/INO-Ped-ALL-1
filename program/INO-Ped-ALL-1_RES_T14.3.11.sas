...
*
* Program name      : INO-Ped-ALL-1_STAT_T14.3.11.sas
*
* Author            : MATSUO YAMAMOTO
*
* Date created      : 20210127
*
* Purpose           : Create T14.3.11
*
* Revision History  : 
*
...
proc sort data=adae(where=(AERELN=1)); by USUBJID AEBDSYCD AEBODSYS AEPTCD AEDECOD decending AETOXGR; run ;
