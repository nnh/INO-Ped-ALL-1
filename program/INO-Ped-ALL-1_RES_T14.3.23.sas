...
*
* Program name      : INO-Ped-ALL-1_STAT_T14.3.23.sas
*
* Author            : MATSUO YAMAMOTO
*
* Date created      : 20210127
*
* Purpose           : Create T14.3.23
*
* Revision History  : 
*
...
data main ;
  set adae ;
  cnt = 1 ;
  if  AEDECOD="Venoocclusive liver disease";
run ;
...
data  main;
  merge  main wk01;
  by  USUBJID;
  if ASTDT>HSCTDT>. then output; /*à⁄êAå„ÇÃVOD*/
run ;
...
data wk00 ;
  ...
  if  b=1 then out1="Å@"||strip(AEDECOD);
