**********************************************************************;
* Project           : INO-Ped-ALL-1_ADaM_LIBNAME
*
* Program name      : INO-Ped-ALL-1_ADaM_LIBNAME.sas
*
...
libname libraw  "&_wk_path.\input\sdtm"  access = readonly;
libname libext  "&_wk_path.\input\ext"      access = readonly;
libname libout  "&_wk_path.\input\ads";

%let output = &_wk_path.\input\ads ;
%let log = &_wk_path.\log\ads;
%let ext = &_wk_path.\input\ext;
%let raw = &_wk_path.\input\sdtm;
