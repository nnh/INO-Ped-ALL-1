...
*
* Program name      : INO-Ped-ALL-1_STAT_T14.2.6.sas
*
* Author            : MATSUO YAMAMOTO
*
* Date created      : 20210127
*
* Purpose           : Create T14.2.6
*
* Revision History  : 
*
...
ods graphics on / height = 10cm width = 15cm imagename = 'T14_2_6'
...
data  master3;
  length OUT1 OUT2 LL UL $200.;
  set  Survivalplot2;
  if  Time<100 and ^missing(Survival);
...
data _null_;
  file sys;
  put '[select("r6c2")]';
  put "[insert.picture(""&output.\KM\T14_2_6.png"")]";
run ;
