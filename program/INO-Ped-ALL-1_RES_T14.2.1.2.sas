...
*
* Program name      : INO-Ped-ALL-1_STAT_T14.2.1.2.sas
*
* Author            : MATSUO YAMAMOTO
*
* Date created      : 20210127
*
* Purpose           : Create T14.2.1.2
*
* Revision History  : 
*
...
data  base;
  set  adrs;
  if  PARAMCD="OVRLRESP";
  if  AVALC in("CR","CRi") then AVALC1="Y";
  else AVALC1="N";
  if  AVALC in("CR") then AVALC2="Y";
  else AVALC2="N";
  if  AVALC in("CRi") then AVALC3="Y";
  else AVALC3="N";
...
%mend;
%xlsout01(&file.,r8c4:r12c6,wk01,OUT1-OUT3);
/*%xlsout01(&file.,r13c3:r13c7,wk02,OUT1-OUT5);*/
/*%xlsout01(&file.,r18c3:r18c7,wk03,OUT1-OUT5);*/
